package cn.hu.zc.float_action_btn;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    public static final int LABELS_ON_CENTER_SIDE = 2;
    ...
    public void setFabAddButtonColorNormal(int color) {
        mAddButtonColorNormal = color;
        mAddButton.setColorNormal(color);
    }

    public void setFabAddButtonColorNormalRes(@ColorRes int color) {
        setFabAddButtonColorNormal(getColor(color));
    }
...
//                int addButtonY = expandUp ? b - t - mAddButton.getMeasuredHeight() : 0;
                int addButtonY;
                if (expandUp) {
                    addButtonY = b - t - mAddButton.getMeasuredHeight();
                } else {
                    addButtonY = 0;
                }
                // Ensure mAddButton is centered on the line where the buttons should be
                int buttonsHorizontalCenter = 0;
                switch (mLabelsPosition) {
                    case LABELS_ON_LEFT_SIDE:
                        buttonsHorizontalCenter = r - l - mMaxButtonWidth / 2;
                        break;
                    case LABELS_ON_RIGHT_SIDE:
                        buttonsHorizontalCenter = mMaxButtonWidth / 2;
                        break;
                    case LABELS_ON_CENTER_SIDE:
                        buttonsHorizontalCenter = r - l - mMaxButtonWidth / 2;
                        break;
                }
...
//                        : buttonsHorizontalCenter + labelsOffset;
                int labelsXNearButton = 0;
                switch (mLabelsPosition) {
                    case LABELS_ON_LEFT_SIDE:
                        labelsXNearButton = buttonsHorizontalCenter - labelsOffset;
                        break;
                    case LABELS_ON_RIGHT_SIDE:
                        labelsXNearButton = buttonsHorizontalCenter + labelsOffset;
                        break;
...
//                                ? labelsXNearButton
//                                : labelXAwayFromButton;
                        int labelXAwayFromButton = 0, labelLeft = 0, labelRight = 0;
                        switch (mLabelsPosition) {
                            case LABELS_ON_LEFT_SIDE:
                            ...
                            case LABELS_ON_RIGHT_SIDE:
                                ...
                                break;
                            case LABELS_ON_CENTER_SIDE:
                                labelXAwayFromButton = labelsXNearButton - label.getMeasuredWidth() / 2;
                                labelLeft = labelXAwayFromButton;
...
//                int addButtonX = expandLeft ? r - l - mAddButton.getMeasuredWidth() : 0;
                int addButtonX;
                if (expandLeft) {
                    addButtonX = r - l - mAddButton.getMeasuredWidth();
                } else {
                    addButtonX = 0;
                }
                // Ensure mAddButton is centered on the line where the buttons should be
...
//            label.setTextSize(mLabelsTextSize);
            addView(label);
